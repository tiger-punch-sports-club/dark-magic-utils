...
#define ALIGN_256(MemorySize) (((MemorySize) + 255) & ~255)
    ...
    // *****************
    // void ClosestPointOnLineSegment (const Vec3 & line_start, const Vec3 & line_end, const Vec3 & point, Vec3 & out_closest_point)
    // {
    //     const Vec3 line = line_end - line_start;
    //     const Vec3 line_start_to_point = point - line_start;
    //     const float projected_length = Clamp (VectorProjectedLength (line_start_to_point, line), 0, 1);
    //     out_closest_point = line_start + line * projected_length;
    // }
}
